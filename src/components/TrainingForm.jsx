...
const TrainingForm = ({ initialData = null, onSubmit }) => {
  ...
  return (
    ...
    <div className="max-w-2xl w-full p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg training-form-container mt-20">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
          >
        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Batch Start Time</label>
            <input
              type="datetime-local"
              name="batchStartTime"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Batch End Time</label>
            <input
              type="datetime-local"
              name="batchEndTime"
          ...
          {/* Weekly Classes */}
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Weekly Classes</label>
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Days (comma separated)</label>
                <input
                  type="text"
                  name="days"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Class Duration</label>
                <input
                  type="text"
                  name="classDuration"
          ...
          <div className="mb-4">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Strength</label>
                <input
                  type="text"
                  name="strength"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Focus</label>
                <input
                  type="text"
                  name="focus"
