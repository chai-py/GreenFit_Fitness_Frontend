...
function Training({ addItemToCart }) {
  ...
  const paidTraining = training.filter(item => item.category === "Paid Training");
    ...
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
        <div className="mt-28 items-center justify-center text-center">
          ...
          <p className="mt-12">
            Our courses range from high-energy cardio sessions to calming yoga flows, designed to improve strength, flexibility, and endurance, with expert guidance and personalized routines for faster and more effective results. Achieve your fitness goals and overall well-being.
          </p>
          <Link to="/">
        ...
        {paidYoga.length > 0 && (
          <div className="mt-12">
            <h2 className="text-2xl font-semibold text-green-600">Yoga For You</h2>
        ...
        {paidTraining.length > 0 && (
          <div className="mt-12">
            <h2 className="text-2xl font-semibold text-green-600">Gym Training</h2>
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-semibold text-green-600">Free Training</h2>
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
